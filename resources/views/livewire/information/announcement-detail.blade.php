    ...
    <section class="py-15 lg:py-20">
        <div class="container mx-auto px-5 lg:px-0">
            <h2 class="heading-42s text-bkkNeutral-900 mb-3">
                Pembukaan Pendaftaran Tracer Study Alumni
            </h2>
            <div class="flex items-center gap-4 paragraph-14r text-bkkNeutral-600">
                <div>Diunggah pada 31 November 2025</div>
                <div class="w-px h-3 bg-bkkNeutral-600"></div>
