    ...
    <section class="py-15 lg:py-20">
        <div class="container flex flex-col lg:flex-row items-start gap-16 mx-auto px-5 lg:px-0 relative">
            <div class="w-full lg:w-[60%]">
                ...
                <h1 class="heading-42s text-bkkNeutral-900 mb-1">
                    Junior Web Developer
                </h1>
                <div class="paragraph-20r text-bkkNeutral-700 mb-6">
                ...
                <div class="flex items-center pargraph-16r text-bkkNeutral-600 gap-3 mb-6">
                    <div>Lamar sebelum 28 Februari 2026</div>
                    {{-- divider --}}
                ...
                <div class="paragraph-16r text-bkkNeutral-700">
                    PT Nusantara Digital Solusi merupakan perusahaan software house yang bergerak di bidang pengembangan teknologi informasi dan solusi digital, meliputi pembuatan aplikasi berbasis web, sistem informasi, serta layanan pengembangan perangkat lunak yang disesuaikan dengan kebutuhan klien, dengan komitmen pada kualitas, inovasi, dan pengembangan sumber daya manusia.
                </div>
            </div>
        </div>
        <div class="w-full lg:w-[40%] lg:sticky top-20">
            <div class="heading-20s text-bkkNeutral-900 mb-9">
